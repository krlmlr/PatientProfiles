...
test_that("plotCohortTiming", {
  ...
  expect_true(all(c("cohort_1", "cohort_2") %in% boxplot1$data$cohort_name_reference))
  expect_true(all(c("cohort_2", "cohort_3", "cohort_4") %in% boxplot1$data$cohort_name_comparator))
  ...
  expect_true(all(c("cohort_1", "cohort_2") %in% boxplot2$data$cohort_name_reference))
  expect_true(all(c("cohort_1", "cohort_2", "cohort_3", "cohort_4") %in% boxplot2$data$cohort_name_comparator))
